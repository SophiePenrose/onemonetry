...
- `GET /api/gemini/handoff/summary` (supports `recent_hours`, `include_recent_status_counts`, `include_recent_retry_counts`, `include_recent_approval_counts`, `include_recent_event_stage_counts`, `include_recent_transport_dispatch_counts`, `include_recent_transport_error_code_counts` query params)
