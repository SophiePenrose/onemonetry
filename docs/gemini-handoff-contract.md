...
- `GET /api/gemini/handoff/summary` (supports `recent_hours`, `include_recent_status_counts`, `include_recent_retry_counts`, `include_recent_approval_counts`, `include_recent_event_stage_counts`, `include_recent_event_volume_counts`, `include_recent_event_type_share`, `include_recent_transport_dispatch_counts`, `include_recent_transport_error_code_counts`, `include_recent_transport_outcome_counts`, `include_queue_backlog_counts`, `include_queue_throughput_counts`, `include_queue_latency_counts`, `include_approval_sync_health_counts`, `include_approval_sync_conflict_counts`, `include_approval_revision_distribution` query params)
