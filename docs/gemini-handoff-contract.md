...
- `GET /api/gemini/handoff/summary` (supports `recent_hours`, `include_recent_status_counts`, `include_recent_retry_counts`, `include_recent_approval_counts` query params)
